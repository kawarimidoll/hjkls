...
T["diagnostics"]["hints style key_notation"] = function()
  ...
  -- Line 231: <cr> should be <CR> (0-indexed: 230)
  local cr_hint = find_diagnostic_at_line(diagnostics, 230)
  ...
  -- Line 235: <UP> should be <Up> (0-indexed: 234)
  local up_hint = find_diagnostic_at_line(diagnostics, 234)
  ...
  -- Line 239: <c-a> should be <C-a> (0-indexed: 238)
  local ctrl_hint = find_diagnostic_at_line(diagnostics, 238)
  ...
  -- Lines 242-245: correct notations should NOT have hints
  -- Line 242: <CR> (0-indexed: 241)
  local valid_cr = find_diagnostic_at_line(diagnostics, 241)
  ...
  -- Line 244: <Up> (0-indexed: 243)
  local valid_up = find_diagnostic_at_line(diagnostics, 243)
